...
#pragma HLS ARRAY_PARTITION variable=partial_mul complete dim=2
    ...
    static float window_buffer[Tn][K][K]; 
...
#pragma HLS ARRAY_PARTITION variable=window_buffer complete dim=3    
    static float line_buffer[Tn][K - 1][OnChipIB_Width];
...
#pragma HLS INTERFACE s_axilite register port=TCol bundle=CTRL_BUS
    ...
    static float output_buffer[Tr][Tc];
...
#pragma HLS ARRAY_PARTITION variable=weight_buffer0 complete dim=4
    static float weight_buffer1[Tn];
#pragma HLS ARRAY_PARTITION variable=weight_buffer1 complete dim=1    
    static float bias_buffer0[Tm]; 
#pragma HLS ARRAY_PARTITION variable=bias_buffer0 complete dim=1    

    static float feature_buffer0_0[Tn][OnChipIB_Width][OnChipIB_Height]; //write to this buffer after 3x3 conv; read this buffer to compute 1x1
#pragma HLS ARRAY_PARTITION variable=feature_buffer0_0 complete dim=1    
    static float feature_buffer0_1[Tn][OnChipIB_Width][OnChipIB_Height]; //add current 3x3 conv result and last 3x3 conv result to this buffer
#pragma HLS ARRAY_PARTITION variable=feature_buffer0_1 complete dim=1    
    static float feature_buffer1_0[Tn][OnChipIB_Width][OnChipIB_Height]; //same as 0_0
#pragma HLS ARRAY_PARTITION variable=feature_buffer1_0 complete dim=1    
    static float feature_buffer1_1[Tn][OnChipIB_Width][OnChipIB_Height]; //read data to compute 3x3 conv
